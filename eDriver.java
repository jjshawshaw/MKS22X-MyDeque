...
public class eDriver {
	...
	public static void main(String[] args) {
		...
		out.add(" adding forward past capacity: \n");
		...
		out.add(" removing from end without wrap: \n");
		...
		out.add(" adding backward past capacity: \n");
		...
		out.add( " removing from front without wrap: \n");
		...
		out.add( " stepping forwards -- this should place us somewhere in the middle of the data array: \n");
		...
		out.add( " adding forward to meet at middle: \n");
		...
		out.add( " removing from end with wrap: \n");
		...
		out.add( " stepping backwards -- this should place us somewhere in the middle of the data array: ");
		...
		out.add( " adding backward to meet at middle: \n");
		...
		out.add( " removing from front with wrap: \n");
